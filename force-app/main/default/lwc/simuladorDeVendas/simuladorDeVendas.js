...
export default class SimuladorDeVendas extends NavigationMixin(LightningElement) {
    ...
    get getProdutoSelecionado(){
        return {
                ...
                'metrosQuadrados': this.produtoSelecionado.metrosQuadrados
                };
    }

    get getProdutoSelectionadoSObject(){
        return {
            'Id': this.produtoSelecionado.id,
            'MetragemTotal__c': this.produtoSelecionado.metrosQuadrados,
            'Empreendimento__c': this.produtoSelecionado.empreendimentoId
        }
    }
