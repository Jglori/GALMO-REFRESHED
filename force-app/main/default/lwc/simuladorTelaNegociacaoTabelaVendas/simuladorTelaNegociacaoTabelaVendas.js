...
export default class SimuladorTelaNegociacaoTabelaVendas extends LightningElement {
    ...
    clearValoresTabela(){
        this.tabelaVendaSelecionada = null;
        this.tabelaVendaValue = null;
        this.inicioVigenciaTabela = null;
        this.fimVigenciaTabela = null;
        this.seriePagamentosTabelaVendas = null;
    }
