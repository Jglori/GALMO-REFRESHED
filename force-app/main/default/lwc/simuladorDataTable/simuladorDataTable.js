...
export default class CustomDataTable extends LightningElement {
    ...
    executarAcaoCustomizadaData() {
        ...
        if (linhasNaoSelecionadas.length > 0) {
            console.log('Nem todos os campos "Dia de Vencimento" foram preenchidos.');
            // this.showToast(
            //     'Erro',
        ...
        console.log('chamando o pxm evento para o pai')
        this.campoDiaVencimento();
    }

    @api
    campoDiaVencimento() {
        console.log('entrei na função filho p o pai - data table');
        const customEvent = new CustomEvent('eventopaidatatable', {
            detail: this.estaSelecionado
        });
        console.log(this.estaSelecionado + ' esta selecionado - campo dia');
